...
Steve Groom (IPAC), Mario Juric (LSSTC),Jeff Kantor (LSSTC),\\
Ron Lambert (NOAO), Kian-Tat Lim (SLAC),Bruce Mather (NCSA), \\
Serge Monkewitz (IPAC),Knut Olsen (NOAO), Steve Pietrowicz (NCSA), \\
Ray Plante (NCSA),Dick Shaw (NOAO), Douglas Smith (SLAC), \\
Schuyler Van Dyk (IPAC), and Daniel Wang (SLAC)\\ 
...
Please address any questions about this document to dm-help@lsstcorp.org.
