...
processing: while the prefiltered variance is a 1\% underestiamte, the
postfiltered varaince is a 5\% underestimate.  As outlined by
...
\caption{Figure illustrating the ability of the kernel basis to
  ...
  centroids of stars.  Roughly, the basis may compensate for local
  astrometric residuals at a scale up to $\sqrt{\sigma_S^2 -
    \sigma_T^2}$.  }
