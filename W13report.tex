...
\caption{Total number of false detections that we expect based on
  a 4000x4072 pixel senser.  We list the total number of positive {\it plus} negative detections;
  they should be present in equal quantities. The variance is as determined from Monte Carlo simulations.\label{tab-fp}
}
\end{table}
