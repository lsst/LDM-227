...
The variance in the prefiltered and postfiltered images is likely to be
...
designed to preserve the noise properties of the image, although this
is not an exact conservation in practice), the variance plane of the
prefiltered data should itself be $\sim$3\% lower than the empirical
