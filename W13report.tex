...
We calculate a mean squared error metric that shows a minimum value close to the configurations
...
measures is shown in Figure XXX
\begin{figure}
...
\item The kernel it able to absorb, individually, random scatter in the astrometry (Figure~\ref{wcsrms})
  ...
  without a significant increase in the number of false positives.  
