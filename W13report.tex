...
Russell Owen (UW), Paul Price (Princeton), Robyn Allsman (LSSTC), \\
Yusra Al Sayyad (UW), Jacek Becla (SLAC), Steve Bickerton (Kavli IPMU),\\
Jim Bosch (Princeton), Scott Daniel (UW), Greg Daues (NCSA),\\
Gregory Dubois-Felsmann (SLAC), Mike Freemon (NCSA),\\
Perry Gee (UC Davis), Bill Glick (NCSA),Steve Groom (IPAC),\\
Joshua Hoblitt (NOAO), Mario Juric (LSSTC), Jeff Kantor (LSSTC),\\
Ron Lambert (NOAO), Dustin Lang (CMU), Kian-Tat Lim (SLAC),\\
Robert Lupton (Princeton), Bruce Mather (NCSA), Serge Monkewitz (IPAC),\\
